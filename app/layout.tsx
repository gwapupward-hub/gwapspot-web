...
import "./premium-ui-scroll-fixes.css";
...
export const metadata: Metadata = {
  ...
  icons: { icon: [{ url: "/logo.png", type: "image/png", sizes: "512x512" }, { url: "/icon-192.png", type: "image/png", sizes: "192x192" }], shortcut: [{ url: "/logo.png", type: "image/png" }], apple: [{ url: "/logo.png", type: "image/png", sizes: "512x512" }] },
};
